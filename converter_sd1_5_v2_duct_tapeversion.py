# -*- coding: utf-8 -*-
"""Converter-SD1.5-V2-Duct-TapeVersion.ipynb
...
#@title ## ♻ **Convert SD 1.5 to Diffusers** (Open for code please!)
...
os.chdir(root_dir)
#@markdown ### **Conversion Config - check the code, you'll need to replace "models/yourmodelhere" with your model details**
#@markdown Make sure to replace: --checkpoint_path content/models/modeltoconvert.safetensors --dump_path content/models/yourmodelshere
#@markdown This is the only way I can get this to work until somehow MIRACULOUSLY - Linaqruf backports the SDXL one to SD 1.5.- OR GPT STOP SCREWING UP MY CODE!
!python diffusers/scripts/convert_original_stable_diffusion_to_diffusers.py --checkpoint_path /content/models/ComicsTest-PoltergeisTUpdatea.safetensors --dump_path /content/models/poltergeistMix_v20 --from_safetensors
